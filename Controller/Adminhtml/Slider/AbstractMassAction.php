...
abstract class AbstractMassAction extends \Magerubik\All\Controller\Adminhtml\AbstractMassAction
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Magerubik_Productslider::slider';
    /**
    ...
    public function __construct(
        ...
        \Magerubik\Productslider\Model\Repository\SliderRepository $repository,
        \Magerubik\Productslider\Model\ResourceModel\Slider\CollectionFactory $collectionFactory
    ) {
